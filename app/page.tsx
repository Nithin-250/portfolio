...
export default function Portfolio() {
  ...
  // Cursor event handlers: move + hover
  useEffect(() => {
  ...
  const funFacts = [
    "I once built a game in under 48 hours during a hackathon.",
    "Ranked Top 50 globally at World Scholar’s Cup (Yale University).",
    "I enjoy playing cricket and keyboard in my free time.",
    "Big fan of Star Wars and sci-fi tech!",
  ];
  ...
  return (
    ...
    >
      {/* Navigation */}
      {/* ... your nav code stays same ... */}

      {/* Hero Section */}
      {/* ... your hero code stays same ... */}

      {/* About Section */}
      {/* ... your about code stays same ... */}

      {/* ⭐ Fun Facts Section */}
      <section id="funfacts" className="py-20 bg-gradient-to-br from-purple-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {funFacts.map((fact, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className="bg-white dark:bg-gray-900 p-6 rounded-2xl shadow-lg hover:shadow-2xl transition transform hover:-translate-y-2"
              >
      ...
      {/* Projects Section */}
      {/* ... your projects code stays same ... */}

      {/* Contact Section */}
      {/* ... your contact code stays same ... */}

      {/* Footer */}
      {/* ... your footer code stays same ... */}
